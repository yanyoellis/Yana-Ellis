const translations = {
  en: {
    ...
    toolsTitle: "TOOLS",
    toolHtml: "HTML / CSS (basic)",
    toolJs: "JavaScript (basic)",
  ...
  ru: {
    ...
    toolHtml: "HTML / CSS (базовый уровень)",
    toolJs: "JavaScript (базовый уровень)",
  ...
  uk: {
    ...
    toolHtml: "HTML / CSS (базовий рівень)",
    toolJs: "JavaScript (базовий рівень)",
  ...
  pl: {
    ...
    toolHtml: "HTML / CSS (podstawy)",
    toolJs: "JavaScript (podstawy)",
