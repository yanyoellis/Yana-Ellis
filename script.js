const translations = {
  en: {
    documentTitle: "Yana Ellis - UX/UI & Web Designer",
  ...
  uk: {
    documentTitle: "Yana Ellis - UX/UI і веб дизайнерка",
    logoAlt: "Логотип Yana Ellis",
    heroRole: "UX/UI І ВЕБ ДИЗАЙНЕРКА, ЩО СПЕЦІАЛІЗУЄТЬСЯ НА САЙТАХ І ЦИФРОВИХ ПРОДУКТАХ.",
  ...
  pl: {
    documentTitle: "Yana Ellis - projektantka UX/UI i web",
    logoAlt: "Logo Yana Ellis",
    heroRole: "PROJEKTANTKA UX/UI I WEB SPECJALIZUJĄCA SIĘ W STRONACH ORAZ PRODUKTACH CYFROWYCH.",
  ...
  de: {
    ...
    clientInfoText:
      "Prüfe FAQ, Datenschutz und Projektbedingungen, bevor du eine Anfrage sendest.",
    clientInfoFaqTitle: "FAQ",
    ...
    clientInfoTermsText: "Projektumfang, Schätzungen, Zahlungen und Nutzungsrechte.",
    footerText:
    ...
    footerEmail: "Email",
    footerTelegram: "Telegram",
    marketClose: "Marktauswahl schließen",
    marketKicker: "Markt auswählen",
    marketTitle: "Wo ist dein Unternehmen tätig?",
    marketDescription:
      "Wähle das Land, in dem dein Unternehmen hauptsächlich tätig ist. Das bestimmt Währung und regionale Preise für die Schätzung.",
    marketCanadaName: "Kanada",
    marketCanadaPrice: "Preise in kanadischen Dollar",
    marketCanadaCopy: "Für Unternehmen, die hauptsächlich in Kanada tätig sind.",
    marketUkraineName: "Ukraine",
    marketUkrainePrice: "Preise in ukrainischen Hrywnja",
    marketUkraineCopy: "Für Unternehmen, die hauptsächlich in der Ukraine tätig sind.",
    marketPolandName: "Polen",
    marketPolandPrice: "Preise in polnischen Zloty",
    marketPolandCopy: "Für Unternehmen, die hauptsächlich in Polen tätig sind.",
