...
ui.de = {
  ...
  calculatorIntro: "Beantworte einige praktische Fragen und erhalte eine erste Schätzung für deine Website.",
  currentEstimate: "Aktuelle Schätzung",
  estimatePlaceholder: "Website-Schätzung",
  ...
  included: "Enthalten",
  startingFrom: "Ab",
  customQuote: "Individuelle Schätzung",
  noneSelected: "Nichts ausgewählt",
  estimatedProjectCost: "Geschaetzte Projektkosten",
  finalCopy: "Dies ist eine erste Schätzung. Der finale Preis wird nach Prüfung der Projektanforderungen bestätigt.",
  ...
  contactHelp: "Markt, Antworten und Schätzung werden in die Anfrage aufgenommen.",
  ...
  descriptionPlaceholder: "Beschreibe kurz dein Business, Ziele und Ideen für die Website.",
  notesPlaceholder: "Was sollte ich vor der Prüfung noch wissen?",
  ...
  notIncludedTitle: "Nicht enthalten, sofern nicht gewählt oder separat angeboten",
  paymentTitle: "Wie die Zahlung funktioniert",
  paymentText: "Projekte werden normalerweise in Zahlungsphasen aufgeteilt. Der genaue Plan wird vor Projektbeginn bestätigt.",
  languageNote: "Bitte stelle finale Übersetzungen bereit. Professionelle Übersetzung kann separat angeboten werden.",
  marketSummary: "Ausgewählter Markt",
  interfaceLanguage: "Interface-Sprache",
  finalEstimate: "Finale Schätzung",
...
const questions = {
  ...
  sizePages: {
    ...
    options: [
      ...
      { id: "four_five_pages", amount: 3000, title: { en: "4-5 pages", uk: "4-5 сторінок", pl: "4-5 podstron" } },
      { id: "six_eight_pages", amount: 6000, title: { en: "6-8 pages", uk: "6-8 сторінок", pl: "6-8 podstron" } },
      { id: "nine_twelve_pages", amount: 10000, title: { en: "9-12 pages", uk: "9-12 сторінок", pl: "9-12 podstron" } },
      {
  ...
  sizeSections: {
    ...
    options: [
      ...
      { id: "nine_twelve_sections", amount: 3000, title: { en: "9-12 content sections", uk: "9-12 секцій контенту", pl: "9-12 sekcji treści" } },
      {
  ...
  businessFeatures: {
    ...
    options: [
      ...
      { id: "gallery", amount: 0, title: { en: "Show a project or photo gallery", uk: "Показати галерею проєктів або фотографій", pl: "Pokazać galerię realizacji lub zdjęć" } },
      { id: "filters", amount: 2000, title: { en: "Allow visitors to filter projects, services or products", uk: "Дозволити фільтрувати проєкти, послуги або товари", pl: "Pozwolić filtrować realizacje, usługi lub produkty" } },
      {
        id: "editable_blog",
        amount: 5000,
        starting: true,
      ...
      { id: "faq", amount: 0, title: { en: "Frequently asked questions section", uk: "Розділ поширених запитань", pl: "Sekcja najczęściej zadawanych pytań" } },
      { id: "reviews", amount: 0, title: { en: "Customer reviews or testimonials", uk: "Відгуки клієнтів", pl: "Opinie klientów" } },
      { id: "map", amount: 0, title: { en: "Interactive map with the business location", uk: "Інтерактивна карта з адресою бізнесу", pl: "Interaktywna mapa z lokalizacją firmy" } },
      { id: "menu", amount: 0, title: { en: "Restaurant, cafe or service menu", uk: "Меню ресторану, кафе або послуг", pl: "Menu restauracji, kawiarni lub usług" } },
  ...
  support: {
    ...
    options: [
      ...
      { id: "future_update", amount: 1000, title: { en: "One future content update", uk: "Одне майбутнє оновлення контенту", pl: "Jedna przyszła aktualizacja treści" } },
      ...
      { id: "monthly_extended", monthly: 3000, title: { en: "Extended monthly support", uk: "Розширена щомісячна підтримка", pl: "Rozszerzone wsparcie miesięczne" } }
    ]
  }
};
