...
const questions = {
  ...
  sizePages: {
    ...
    options: [
      ...
      { id: "two_three_pages", amount: 2000, title: { en: "2-3 pages", uk: "2-3 сторінки", pl: "2-3 podstrony" } },
      { id: "four_five_pages", amount: 4000, title: { en: "4-5 pages", uk: "4-5 сторінок", pl: "4-5 podstron" } },
      { id: "six_eight_pages", amount: 7000, title: { en: "6-8 pages", uk: "6-8 сторінок", pl: "6-8 podstron" } },
      { id: "nine_twelve_pages", amount: 11000, title: { en: "9-12 pages", uk: "9-12 сторінок", pl: "9-12 podstron" } },
      {
  ...
  sizeSections: {
    ...
    options: [
      ...
      { id: "six_eight_sections", amount: 2000, title: { en: "6-8 content sections", uk: "6-8 секцій контенту", pl: "6-8 sekcji treści" } },
      { id: "nine_twelve_sections", amount: 4000, title: { en: "9-12 content sections", uk: "9-12 секцій контенту", pl: "9-12 sekcji treści" } },
      {
  ...
  contactFeatures: {
    ...
    options: [
      ...
      { id: "file_upload", amount: 2000, title: { en: "Allow visitors to upload files", uk: "Дозволити відвідувачам завантажувати файли", pl: "Pozwolić odwiedzającym przesyłać pliki" } },
      {
        id: "newsletter",
        amount: 1500,
  ...
  businessFeatures: {
    ...
    options: [
      ...
      { id: "filters", amount: 3000, title: { en: "Allow visitors to filter projects, services or products", uk: "Дозволити фільтрувати проєкти, послуги або товари", pl: "Pozwolić filtrować realizacje, usługi lub produkty" } },
      {
        id: "editable_blog",
        amount: 6500,
        starting: true,
      ...
      { id: "menu", amount: 2500, title: { en: "Restaurant, cafe or service menu", uk: "Меню ресторану, кафе або послуг", pl: "Menu restauracji, kawiarni lub usług" } },
      { id: "before_after", amount: 2500, title: { en: "Interactive before-and-after images", uk: "Інтерактивне порівняння до та після", pl: "Interaktywne porównanie przed i po" } },
      {
        id: "downloads",
        amount: 1000,
  ...
  support: {
    ...
    options: [
      ...
      { id: "monthly_basic", monthly: 2000, title: { en: "Basic monthly support", uk: "Базова щомісячна підтримка", pl: "Podstawowe wsparcie miesięczne" } },
      { id: "monthly_extended", monthly: 4000, title: { en: "Extended monthly support", uk: "Розширена щомісячна підтримка", pl: "Rozszerzone wsparcie miesięczne" } }
    ]
  }
};
